# VPN Scanner - ScreenConnect Optimized Version
# This version is optimized for running via ConnectWise ScreenConnect Command tab
# Usage: Copy the entire script content into ScreenConnect's Command tab

param(
    [int]$DaysBack = 30,
    [string]$OutputFile = "$env:TEMP\VPN_IPs_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
